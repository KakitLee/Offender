...
import com.qingyangli.offender.MySharedPreferences;
import com.project.zhi.tigerapp.R;
import com.qingyangli.offender.activities.SettingsActivityVoice;
...
public class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        aboutPref.setSummary(getString(R.string.pref_about_desc, ""));
        aboutPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                LicensesFragment licensesFragment = new LicensesFragment();
                licensesFragment.show(((SettingsActivityVoice)getActivity()).getSupportFragmentManager().beginTransaction(), "dialog_licenses");
                return true;
            }
        });
    }
